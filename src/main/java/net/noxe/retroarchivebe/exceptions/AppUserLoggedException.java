...
@Getter
public class AppUserLoggedException extends RuntimeException {
    ...
    public AppUserLoggedException(String message, Logger logger, Level level) {
    ...
    public AppUserLoggedException(String message, HttpStatus status, Logger logger, Level level) {
        this.timestamp = LocalDateTime.now();
        this.message = message;
        this.status = status;
        this.logger = logger;
    ...
    public AppUserLoggedException(String message, HttpStatus status, Logger logger, Level level, Object... args) {
        this.timestamp = LocalDateTime.now();
