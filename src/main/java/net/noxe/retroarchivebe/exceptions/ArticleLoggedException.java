...
@Getter
public class ArticleLoggedException extends RuntimeException {
    ...
    public ArticleLoggedException(String message, Logger logger, Level level) {
    ...
    public ArticleLoggedException(String message, HttpStatus status, Logger logger, Level level) {
        this.timestamp = LocalDateTime.now();
        this.message = message;
        this.status = status;
        this.logger = logger;
    ...
    public ArticleLoggedException(String message, HttpStatus status, Logger logger, Level level, Object... args) {
        this.timestamp = LocalDateTime.now();
