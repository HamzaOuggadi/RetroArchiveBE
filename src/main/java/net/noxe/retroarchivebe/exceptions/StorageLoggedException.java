...
@Getter
public class StorageLoggedException extends RuntimeException {
    ...
    public StorageLoggedException(String message, Logger logger, Level level) {
    ...
    public StorageLoggedException(String message, HttpStatus status, Logger logger, Level level) {
        this.timestamp = LocalDateTime.now();
        this.message = message;
        this.status = status;
        this.logger = logger;
    ...
    public StorageLoggedException(String message, HttpStatus status, Logger logger, Level level, Object... args) {
        this.timestamp = LocalDateTime.now();
